    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mViewModel.anglesLiveData.observe(viewLifecycleOwner) {
            ...
            mBinding.apply {
                ...
                angleWhenShiftingGear.value = it.shiftIgnTim
                alwaysUseWorkingMap.isChecked = it.ignTimWrkMap
                applyManualIgnitionCorrection.isChecked = it.manIngTimIdl
                zeroAdvAngleWithCorrection.isChecked = it.zeroAdvAngOct
            }
