...
class StarterFragment : BaseParamFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mViewModel.starterLiveData.observe(viewLifecycleOwner) {
            ...
            mBinding.apply {
                ...
                startersBlockingTimer.value = it.stblStrCnt
                floodCleanStart.isChecked = it.floodClearStart
    ...
    private fun initViews() {
        ...
        mBinding.apply {
            ...
            startersBlockingTimer.addOnValueChangeListener {
                packet?.stblStrCnt = it
                packet?.let { it1 -> mViewModel.sendPacket(it1) }
            }

            floodCleanStart.setOnCheckedChangeListener { _, isChecked ->
                packet?.floodClearStart = isChecked
                packet?.let { it1 -> mViewModel.sendPacket(it1) }
            }
            ...
            startersBlockingTimer.setOnClickListener { intParamClick(it as IntParamView) }
        }
    }
}