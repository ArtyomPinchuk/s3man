...
data class CkpsParamPacket(
    ...
    override fun pack(): String {
        ...
        data += hallWndWidth.times(LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER).toInt().write2Bytes()
        data += hallDegreesBtdc.times(LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER).toInt().write2Bytes()
    ...
    companion object {
        ...
        fun parse(data: String) = CkpsParamPacket().apply {
            ...
            hallWndWidth = data.get2Bytes(8).toFloat() / LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER
            hallDegreesBtdc = data.get2Bytes(10).toFloat() / LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER
        }
    }
}
