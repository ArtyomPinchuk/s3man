...
data class UniOutParamPacket(
    ...
    private fun decodeCondVal(value: Int, condition: Int): Float {
        when (condition) {
            ...
            CONDITION_UBAT -> return value.toFloat() / UBAT_MULTIPLIER
            ...
            CONDITION_AANG -> return value.toFloat() / LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER
    ...
    private fun encodeCondVal(value: Float, condition: Int): Int {
        when (condition) {
            ...
            CONDITION_UBAT -> return (value * UBAT_MULTIPLIER).roundToInt()
            ...
            CONDITION_AANG -> return (value * LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER).roundToInt()
    ...
    companion object {
        ...
        fun parse(data: String) = UniOutParamPacket().apply {
            ...
            rawOutput1Flags = data[2].toInt()
            output1Condition1 = data[3].toInt()
            output1Condition2 = data[4].toInt()
            ...
            rawOutput2Flags = data[13].toInt()
            output2Condition1 = data[14].toInt()
            output2Condition2 = data[15].toInt()
            ...
            rawOutput3Flags = data[24].toInt()
            output3Condition1 = data[25].toInt()
            output3Condition2 = data[26].toInt()
