...
data class MiscellaneousParamPacket(
    ...
    override fun pack(): String {
        ...
        data += hopStartAng.times(LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER).write2Bytes()
        data += hopDuratAng.times(LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER).write2Bytes()
    ...
    companion object {
        ...
        fun parse(data: String) = MiscellaneousParamPacket().apply {
            ...
            hopStartAng = data.get2Bytes(8).div(LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER)
            hopDuratAng = data.get2Bytes(10).div(LOAD_PHYSICAL_MAGNITUDE_MULTIPLIER)
